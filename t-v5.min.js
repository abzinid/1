        ...
        tgw = {
            ...
            ajax_process: '<div class="messages_loader"><img src="https://tgwidget.com/channel/v2.0/images/loading.gif?v=1" /></div>',
            count_max_request: 60,
            count_exec_request: 0,

            render: function () {
                $('.tg-body').css({
                    'height': $(window).height() - $a('.tg-head').outerHeight() - $('.btn-footer-line').outerHeight()
                })
            ...
            remove_update: function (update_id, date) {
                ...
                $.ajax({
                    url: 'https://tgwidget.com/widget/action/index.php',
                    type: 'POST',
                    data: {
            ...
            get_history: function () {
                ...
                if($('.tg-body').size()){
                    ...
                    $.ajax({
                        url: 'https://tgwidget.com/channel/v2.0/index.php',
                        type: 'POST',
                        cache: false,
                        data: {
                            id: tgw.peer_id,
